...
\newcommand{\stickdiagram}[1]{\subsubsection*{Stick Diagram} \includegraphics[width=\textwidth,height=10cm,keepaspectratio=true]{#1}}
\newcommand{\transistor}[1]{\subsubsection*{Transistor Level Circuit Diagram} \includegraphics[width=\textwidth,height=8cm,keepaspectratio=true]{#1}}
\newcommand{\spicesim}[1]{\subsubsection*{HSpice Simulation} \includegraphics[width=0.5\textwidth,height=10cm,keepaspectratio=true]{#1}}
